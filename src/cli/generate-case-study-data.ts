...
async function main() {
  ...
  const topFivePatterns = [
    ...
    {
      pattern_id: 5,
      headline: "Verification Revealed Conservative Guardrails as a Major Source of False UNCLEAR Verdicts",
      supporting_metric: "5 of 7 sampled baseline UNCLEAR verdicts (71.4%) were resolved during independent verification. The remaining 54 baseline-unverified UNCLEAR apps were intentionally preserved rather than extrapolating the sample result to unverified records.",
  ...
  const caseStudyData = {
    ...
    methodology_and_provenance_definitions: {
      ...
      baseline_unverified_conservative_unclear: "54 baseline-unverified conservative UNCLEAR — retained because the one-pass system did not produce enough validated evidence for confident promotion."
    },
